<!-- KS-TRACE: 4.12E-COC | assumption: standard, widely-recognized text (Contributor Covenant v2.1), not bespoke legal-adjacent wording, per 4.12-E must-close instruction | test: live check — github.com/FixProve/fixprove/blob/main/CODE_OF_CONDUCT.md renders non-empty and GitHub's own Community/Insights tab picks it up -->
...
**egorka30001@gmail.com**. All complaints will be reviewed and investigated
promptly and fairly.
